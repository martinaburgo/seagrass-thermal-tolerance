...
Dens overlay
```{r}
seagrass.brm6 |> pp_check(type = 'dens_overlay', ndraws = 100) #maybe make priors smaller?
```
...
Dens overlay
```{r}
seagrass.brm7 |> pp_check(type = 'dens_overlay', ndraws = 100) #maybe make priors smaller?
```
